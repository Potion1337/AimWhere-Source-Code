...
public class UITextField extends Gui
{
    ...
    public UITextField(int componentId, UnicodeFontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                //drawRect(this.xPosition, this.yPosition, this.xPosition + this.width + 1, this.yPosition + this.height + 1, -6250336);
                //drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
            }
            if(!isFocused && text.isEmpty())
                FontManager.array16.drawString("UserName", xPosition + 5,yPosition + 9,new Color(180,180,180).getRGB());
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.drawString(s1, l, i1 + 3, new Color(60,60,60).getRGB());
            }
            ...
            {
                j1 = this.fontRendererInstance.drawString(s.substring(j), j1, i1, new Color(60,60,60).getRGB());
            }
            ...
            if (flag1)
            {
                ...
                {
                    this.fontRendererInstance.drawString("_", xPosition + 5 + fontRendererInstance.getStringWidth(text), i1 + 3, new Color(60,60,60).getRGB());
                }
            }
