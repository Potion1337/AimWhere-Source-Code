...
import me.kiras.aimwhere.ui.guis.ClickGUISettings.InputBox;
import me.kiras.aimwhere.ui.guis.ModueSettings.Settings;
...
public class LightClickGUI extends GuiScreen implements GuiYesNoCallback {
    ...
    private final UnicodeFontRenderer defaultFont = FontManager.array14;
    private final UnicodeFontRenderer logoFont = FontManager.array20;
...
//        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        RenderUtils.drawImage(new ResourceLocation( "AimWhere/custom_hud_icon.png"), 9, height - 41, 32, 32);
        ...
        defaultFont.drawString(searchBox.getText().isEmpty() && !searchBox.isFocused() ? "Search..." : searchBox.getText(), startX + 3, startY + 25, new Color(80,80,80).getRGB());
...
//            hovered = false;
        ...
        logoFont.drawString(currentCategory.getDisplayName(), startX + 60, startY + 10,
        ...
        if(!searchBox.getText().isEmpty()) {
            ...
            for(int i = 0; i < LiquidBounce.moduleManager.getModulesByName(searchBox.getText()).size(); i++) {
                ...
                if(module.getAnimation().getAnimationX() > -5F && !module.getState())
                    ...
                    module.getAnimation().animationX += 1F;
                defaultFont.drawString(module.getName(), startX + 65, mY + 6, moduleColor);
                defaultFont.drawString("KeyBind: " + (!Keyboard.getKeyName(module.getKeyBind()).equalsIgnoreCase("NONE") ? Keyboard.getKeyName(module.getKeyBind()) : "None"), startX + 65, mY + 13, new Color(80, 80, 80,alphaAnim.getAlpha()).getRGB());
        ...
        if (currentModule != null) {
            logoFont.drawString(currentModule.getName(), startX + 205, startY + 10,
            ...
            if(searchBox.getText().isEmpty()) {
                for (int i = 0; i < LiquidBounce.moduleManager.getModuleInCategory(currentCategory).size(); i++) {
                    ...
                    if(module.getAnimation().getAnimationX() > -5F && !module.getState())
                        ...
                        module.getAnimation().animationX += 1F;
                    defaultFont.drawString(module.getName(), startX + 65, mY + 6, moduleColor);
                    defaultFont.drawString("KeyBind: " + (!Keyboard.getKeyName(module.getKeyBind()).equalsIgnoreCase("NONE") ? Keyboard.getKeyName(module.getKeyBind()) : "None"), startX + 65, mY + 13, /*!module.getState() ? */new Color(80, 80, 80,alphaAnim.getAlpha()).getRGB() /*: new Color(220, 220, 220).getRGB()*/);
                    if (!Mouse.isButtonDown(0)) {
                        this.previousMouse = false;
                    }
            ...
            if (currentModule.getValues().isEmpty())
                logoFont.drawString("Empty Settings", startX + 250, startY + 130,
                        new Color(100, 100, 100,valueAnim.getAlpha()).getRGB());
...
//                        || currentCategory == ModuleCategory.WORLD ? -1 : */new Color(107, 107, 107).getRGB());
        RenderUtils.drawImage(new ResourceLocation("AimWhere/clickgui/Combat.png"),(int)startX + 17, (int)startY + 43, 16, 16);
        RenderUtils.drawImage(new ResourceLocation("AimWhere/clickgui/Player.png"),(int)startX + 17, (int)startY + 90, 16, 16);
        RenderUtils.drawImage(new ResourceLocation("AimWhere/clickgui/Move.png"),(int)startX + 17, (int)startY + 136, 16, 16);
        RenderUtils.drawImage(new ResourceLocation("AimWhere/clickgui/Render.png"),(int)startX + 17, (int)startY + 180, 16, 16);
        RenderUtils.drawImage(new ResourceLocation("AimWhere/clickgui/World.png"),(int)startX + 17, (int)startY + 226, 16, 16);
    }
