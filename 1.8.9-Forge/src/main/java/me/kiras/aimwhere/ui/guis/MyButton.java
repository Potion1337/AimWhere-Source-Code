...
public class MyButton extends GuiButton
{
    ...
    public MyButton(final int buttonId, final int x, final int y, final int widthIn, final int heightIn, final String buttonText) {
        ...
        this.color = color;
        this.font = FontManager.Chinese16;
    }

    public MyButton(final int buttonId, final int x, final int y, final int widthIn, final int heightIn, final String buttonText, final int color, final UnicodeFontRenderer font) {
        super(buttonId, x, y, 10, 12, buttonText);
        this.time = new TimerUtil();
        this.width = widthIn;
        this.height = heightIn;
