...
import me.kiras.aimwhere.utils.math.Vec3f;
...
public class GLUtils
{
    ...
    public static Vec3f toWorld(double x, double y, double z) {
        boolean result = GLU.gluUnProject(((float)x), ((float)y), ((float)z), MODELVIEW, PROJECTION, (IntBuffer)VIEWPORT, (FloatBuffer)((FloatBuffer)TO_WORLD_BUFFER.clear()));
        if (result) {
    ...
    public static Vec3f toScreen(double x, double y, double z) {
        boolean result = GLU.gluProject(((float)x), ((float)y), ((float)z), MODELVIEW, PROJECTION, (IntBuffer)VIEWPORT, (FloatBuffer)((FloatBuffer)TO_SCREEN_BUFFER.clear()));
        if (result) {
