...
public class MouseOverArea extends AbstractComponent {
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.gui.AbstractComponent#render(me.kiras.aimwhere.libraries.slick.gui.GUIContext,
	 *      me.kiras.aimwhere.libraries.slick.Graphics)
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#mouseMoved(int, int, int, int)
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#mouseDragged(int, int, int, int)
	 */
