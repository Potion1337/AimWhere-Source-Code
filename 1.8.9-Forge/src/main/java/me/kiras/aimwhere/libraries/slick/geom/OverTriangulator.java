...
public class OverTriangulator implements Triangulator {
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.geom.Triangulator#addPolyPoint(float, float)
	 */
	public void addPolyPoint(float x, float y) {
	}

	/**
	 * @see me.kiras.aimwhere.libraries.slick.geom.Triangulator#getTriangleCount()
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.geom.Triangulator#getTrianglePoint(int, int)
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.geom.Triangulator#startHole()
	 */
	public void startHole() {
	}

	/**
	 * @see me.kiras.aimwhere.libraries.slick.geom.Triangulator#triangulate()
	 */
