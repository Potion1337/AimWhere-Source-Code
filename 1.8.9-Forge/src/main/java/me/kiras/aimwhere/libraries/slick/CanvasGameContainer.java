...
public class CanvasGameContainer extends Canvas {
	...
	private class Container extends AppGameContainer {
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.GameContainer#running()
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.GameContainer#getHeight()
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.GameContainer#getWidth()
		 */
		public int getWidth() {
