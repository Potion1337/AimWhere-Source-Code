...
public class StreamSound extends AudioImpl {
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioImpl#isPlaying()
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioImpl#playAsMusic(float, float, boolean)
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean, float, float, float)
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean)
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioImpl#stop()
	 */
	public void stop() {
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioImpl#setPosition(float)
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioImpl#getPosition()
	 */
