...
public class InputProvider {
	...
	private class InputListenerImpl extends InputAdapter {
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#isAcceptingInput()
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#keyPressed(int, char)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#keyReleased(int, char)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#mousePressed(int, int, int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#mouseReleased(int, int, int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerLeftPressed(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerLeftReleased(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerRightPressed(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerRightReleased(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerUpPressed(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerUpReleased(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerDownPressed(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerDownReleased(int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerButtonPressed(int,
		 *      int)
		 */
		...
		/**
		 * @see me.kiras.aimwhere.libraries.slick.util.InputAdapter#controllerButtonReleased(int,
		 *      int)
		 */
