 ...
 */
public class TrueTypeFont implements me.kiras.aimwhere.libraries.slick.Font {
	...
	public void drawString(float x, float y, String whatchars,
			me.kiras.aimwhere.libraries.slick.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, me.kiras.aimwhere.libraries.slick.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
                           me.kiras.aimwhere.libraries.slick.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, me.kiras.aimwhere.libraries.slick.Color.white);
	}
