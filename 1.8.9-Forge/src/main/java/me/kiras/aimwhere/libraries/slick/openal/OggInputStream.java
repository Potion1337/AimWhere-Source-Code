...
public class OggInputStream extends InputStream implements AudioInputStream {
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioInputStream#getChannels()
	 */
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioInputStream#getRate()
	 */
	public int getRate() {
		return oggInfo.rate;
	}
	...
	/**
	 * @see me.kiras.aimwhere.libraries.slick.openal.AudioInputStream#atEnd()
	 */
