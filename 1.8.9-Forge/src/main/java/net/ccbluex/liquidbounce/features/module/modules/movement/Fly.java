...
public class Fly extends Module {
    ...
    // RedeSky
    private final FloatValue rssSpeedValue = new FloatValue("RedeSky-Speed", 0.76F, 0.05F, 1F);
    private final FloatValue rssSpeedChangeValue = new FloatValue("RedeSky-ChangeSpeed", 0.82F, -1F, 1F);
    private final FloatValue rssMotionValue = new FloatValue("RedeSky-Motion", 0.39F, 0F, 0.5F);
    private final FloatValue rssTimerValue = new FloatValue("RedeSky-Timer", 0.94F, 0.1F, 1F);
    private final FloatValue rssDropoffValue = new FloatValue("RedeSky-DownPosY", 2.23F, 0F, 5F);
    private final BoolValue rssDropoff = new BoolValue("RedeSky-DownY", true);
