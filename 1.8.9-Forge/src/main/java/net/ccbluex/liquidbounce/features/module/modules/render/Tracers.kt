...
class Tracers : Module() {
    private val xPosValue = createFloatValue("PosX", 0.0F,-1.0F,1.0F)
    private val yPosValue = createFloatValue("PosY", 0.0F,-1.0F,1.0F)
    private val zPosValue = createFloatValue("PosZ", 0.0F,-1.0F,1.0F)
    ...
    private fun drawTraces(entity: Entity, color: Color) {
        ...
        GL11.glVertex3d(eyeVector.xCoord + xPosValue.get(), mc.thePlayer.getEyeHeight().toDouble() + eyeVector.yCoord + yPosValue.get(), eyeVector.zCoord + zPosValue.get())
