...
public class StorageESP extends Module {
    ...
    private final BoolValue furnaceValue = new BoolValue("Furnace", false);
    private final BoolValue dispenserValue = new BoolValue("Dispenser", false);
    private final BoolValue hopperValue = new BoolValue("Hopper", false);
