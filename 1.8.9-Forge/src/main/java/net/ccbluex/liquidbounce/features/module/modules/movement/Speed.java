...
public class Speed extends Module {
    ...
    public final FloatValue redeSkyHopGSpeed = new FloatValue("RedeSky-GSpeed", 0.3F, 0.1F, 0.7F);
    public final FloatValue redeSkyHopHeight = new FloatValue("RedeSky-Height", 0.45F, 0.30F, 0.55F);
    public final FloatValue redeSkyHopTimer = new FloatValue("RedeSky-Timer", 6F, 1.1F, 10F);
    @EventTarget
