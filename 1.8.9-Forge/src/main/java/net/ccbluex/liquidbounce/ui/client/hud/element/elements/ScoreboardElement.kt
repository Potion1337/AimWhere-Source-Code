...
class ScoreboardElement(x: Double = 5.0, y: Double = 0.0, scale: Float = 1F,
    ...
    override fun drawElement(): Border? {
        ...
        scoreCollection.forEachIndexed { index, score ->
            ...
            fontRenderer.drawString(if (name.contains("mc110.cc") || name.contains("hypixel") || name.contains("redesky") || name.contains(".net")) "www.aimwhere.com" else name, l1.toFloat(), height.toFloat(), if (name.contains("mc110.cc") || name.contains("hypixel") || name.contains("redesky") || name.contains(".net")) ColorManager.getChromaRainbow(l1.toDouble(),height.toDouble()).rgb else textColor, shadowValue.get())
